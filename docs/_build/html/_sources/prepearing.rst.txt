...
RemoApp_ - приложение, в котором будет производиться разметка изображений.

.. _RemoApp: https://remo.ai/

Установка производится через командную строку.

Для начала необходимо открыть командную строку. Это можно сделать, нажав сочетание клавиш «Ctrl+Shift+T». Далее обновить PostgreSQL:
::
